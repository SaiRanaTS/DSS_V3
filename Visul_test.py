...
ax = plt.subplots()
plt.subplots_adjust(left=0.06, right=0.95, top=1.2, bottom=0.0)
plt.imshow(img, extent=[-4122, 6028, -400, 4675], alpha=0.96)
plt.xlim([-4122, 6028])
plt.ylim([-400, 4675])
plt.xlabel('East (m)')
plt.ylabel('North (m)')
